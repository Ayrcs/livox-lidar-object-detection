...
from lidar_detection_ros.messages import detection_array_message
...
class LidarDetectionNode(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("output_topic", "/lidar/detections_3d")
        self.declare_parameter("output_frame", "lidar_corrected")
        ...
        self.get_logger().info(f"Listening on {input_topic}; publishing detections on {output_topic}")
    ...
    def _on_cloud(self, message: PointCloud2) -> None:
        try:
            ...
            output = detection_array_message(
                detections,
